...
internal sealed class CreateExerciseResolveCommandHandler : IRequestHandler<CreateExerciseResolveCommand, ExerciseResolve>
{
    ...
    public async Task<ExerciseResolve> Handle(CreateExerciseResolveCommand request, CancellationToken cancellationToken)
    {
        ...
        var estimatedTime = await _resolveTimeMeasurer.MeasureAsync(resolve);
        ...
        await _exerciseResolveRepository.SaveExerciseResolveChangesAsync(cancellationToken);

        return exerciseResolve;
    }
}
